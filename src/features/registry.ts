...
export const TOOLS: ToolDefinition[] = [
  ...
  },
  {
    id: 'jpg-to-pdf',
    name: 'JPG to PDF',
    description: 'Convert JPG, PNG, or SVG images into a PDF (client-side).',
  ...
  },
  {
    id: 'raster-to-pdf',
    name: 'Raster to PDF',
    description: 'Convert WEBP, BMP, GIF, or TIFF images to PDF via server.',
    category: 'Convert To PDF',
    icon: ImageDown,
    accepts: 'raster',
    multiple: false,
    execution: { kind: 'backend', endpoint: API.paths.imageToPdf },
    output: {
      naming: { strategy: 'derive', ext: 'pdf' },
      mimeType: MIME.pdf,
      delivery: 'preview',
      successMessage: 'Image converted to PDF',
    },
  },
  {
    id: 'markdown-to-pdf',
  ...
  },
  {
    id: 'word-to-pdf',
    name: 'Word to PDF',
    description: 'Convert DOCX, DOC, ODT, or RTF documents to PDF.',
    category: 'Convert To PDF',
    icon: FileText,
    accepts: 'document',
    execution: { kind: 'backend', endpoint: API.paths.toPdf },
    output: {
      naming: { strategy: 'derive', ext: 'pdf' },
      mimeType: MIME.pdf,
      delivery: 'preview',
  ...
  },
  {
    id: 'excel-to-pdf',
    name: 'Excel to PDF',
    description: 'Convert XLSX, XLS, ODS, or CSV spreadsheets to PDF.',
    category: 'Convert To PDF',
    ...
    output: {
      ...
      mimeType: MIME.pdf,
      delivery: 'preview',
      successMessage: 'Spreadsheet converted to PDF',
    },
  },
  {
    ...
    output: {
      ...
      mimeType: MIME.pdf,
      delivery: 'preview',
      successMessage: 'Presentation converted to PDF',
    },
  },
  {
    id: 'html-to-pdf',
    name: 'HTML to PDF',
    description: 'Convert HTML web pages to PDF (preserves CSS via WeasyPrint).',
    category: 'Convert To PDF',
    icon: Globe,
    accepts: 'html',
    execution: { kind: 'backend', endpoint: API.paths.toPdf },
  ...
  },
  {
    id: 'pdf-to-word',
    name: 'PDF to Word',
    description: 'Extract PDF text into editable DOCX (text-based, layout may differ).',
  ...
  },
  {
    id: 'pdf-to-excel',
    name: 'PDF to Excel',
    description: 'Extract PDF tables and text into XLSX (text-based).',
    category: 'Convert From PDF',
    icon: FileSpreadsheet,
    accepts: 'pdf',
  ...
  },
  {
    ...
    description: 'Convert each PDF page into a PPTX slide image.',
    category: 'Convert From PDF',
    icon: Presentation,
    accepts: 'pdf',
  ...
  },
  {
    id: 'pdf-to-jpg',
    name: 'PDF to JPG',
    description: 'Render each PDF page as a JPG image (zipped download).',
    category: 'Convert From PDF',
    icon: FileImage,
    accepts: 'pdf',
    execution: { kind: 'backend', endpoint: API.paths.pdfToImages },
    output: {
      naming: { strategy: 'derive', suffix: '_pages', ext: 'zip' },
      mimeType: MIME.zip,
      delivery: 'download',
      successMessage: 'PDF converted to JPG images',
    },
  },
  {
    id: 'pdf-to-png',
    name: 'PDF to PNG',
    description: 'Render each PDF page as a PNG image (zipped download).',
    category: 'Convert From PDF',
    icon: FileImage,
    accepts: 'pdf',
    execution: { kind: 'backend', endpoint: API.paths.pdfToImages },
    output: {
      ...
      mimeType: MIME.zip,
      delivery: 'download',
      successMessage: 'PDF converted to PNG images',
    },
  },
  {
    id: 'pdf-to-text',
    ...
    icon: FileCode,
    accepts: 'pdf',
    execution: { kind: 'backend', endpoint: API.paths.pdfToText },
    output: {
      naming: { strategy: 'derive', ext: 'txt' },
      mimeType: MIME.plain,
      delivery: 'download',
      successMessage: 'PDF converted to text',
    },
  },
  {
    id: 'pdf-to-html',
    name: 'PDF to HTML',
    description: 'Export PDF content as an HTML document.',
    category: 'Convert From PDF',
    icon: Globe,
    accepts: 'pdf',
    execution: { kind: 'backend', endpoint: API.paths.pdfToHtml },
    output: {
      naming: { strategy: 'derive', ext: 'html' },
      mimeType: MIME.html,
      delivery: 'download',
      successMessage: 'PDF converted to HTML',
    },
  },
  {
    id: 'ocr',
